...
{
    /// <inheritdoc />
    public partial class AddModule7AuditAndNotes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanReviewNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanReviewNotes_BusinessPlans_BusinessPlanId",
                        column: x => x.BusinessPlanId,
                        principalTable: "BusinessPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanReviewNotes_Users_ReviewerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanReviewNotes_BusinessPlanId",
                table: "PlanReviewNotes",
                column: "BusinessPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanReviewNotes_ReviewerUserId",
                table: "PlanReviewNotes",
