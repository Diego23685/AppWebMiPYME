        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetTokenExpiresUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessPlans_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BusinessPlans_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InflationRate = table.Column<decimal>(type: "numeric(5,4)", precision: 5, scale: 4, nullable: false),
                    IncomeTaxRate = table.Column<decimal>(type: "numeric(5,4)", precision: 5, scale: 4, nullable: false),
                    DiscountRate = table.Column<decimal>(type: "numeric(5,4)", precision: 5, scale: 4, nullable: false),
                    DaysSalesOutstanding = table.Column<int>(type: "integer", nullable: false),
                    DaysPayableOutstanding = table.Column<int>(type: "integer", nullable: false),
                    InitialInvestment = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    WorkingCapital = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialAssumptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FinancialAssumptions_BusinessPlans_BusinessPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessPlans_CourseId",
                table: "BusinessPlans",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessPlans_StudentId",
                table: "BusinessPlans",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialAssumptions_BusinessPlanId",
                table: "FinancialAssumptions",
